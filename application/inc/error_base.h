...
typedef enum {
	...
	ERROR_BASE_TIM_RAINFALL = (ERROR_BASE_TIM_WIND_SPEED + TIM_ERROR_BASE_LAST),
	// Utils.
	ERROR_BASE_MATH = (ERROR_BASE_TIM_RAINFALL + TIM_ERROR_BASE_LAST),
	ERROR_BASE_PARSER = (ERROR_BASE_MATH + MATH_ERROR_BASE_LAST),
	ERROR_BASE_STRING = (ERROR_BASE_PARSER + PARSER_ERROR_BASE_LAST),
	// Components.
	ERROR_BASE_SEN15901 = (ERROR_BASE_STRING + STRING_ERROR_BASE_LAST),
	// Last base value.
	ERROR_BASE_LAST = (ERROR_BASE_SEN15901 + SEN15901_ERROR_BASE_LAST)
} ERROR_base_t;
